...
public class UserAccountServiceImpl implements UserAccountService {
    ...
    public PageDTO<UserAccountVO> getAccountList(UserAccountQuery query) {
        ...
        // Object p = PageResult.of(voList, userPage.getTotal(), query.getPageNum(), query.getPageSize());
        PageDTO<UserAccountVO> pageDTO = new PageDTO<>();
        pageDTO.setPageIndex(query.getPageNum().longValue());
        pageDTO.setPageSize(query.getPageSize().longValue());
