...
public class RegistryRecordsQuery extends PageQuery {
     ...
     * 课程
     */
    @ApiModelProperty(value = "课程", example = "粤语")
    private String name;

    /**
     * 科目
     */
    @ApiModelProperty(value = "科目", example = "数学")
    private String subjectName;

    /**
     * 类型
     */
    @ApiModelProperty(value = "类型【0-新签，1-续签】", example = "0")
     ...
     * 退费状态
     */
    @ApiModelProperty(value = "退费状态【1-待审核 2-已审核】", example = "1")
