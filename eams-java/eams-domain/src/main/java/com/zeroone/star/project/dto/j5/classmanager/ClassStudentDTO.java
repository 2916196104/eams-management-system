...
public class ClassStudentDTO {
    @ApiModelProperty(value = "班级id,如果保存必须传，新增不传")
    private Long id;
    ...
    @ApiModelProperty(value = "班级创建时间",example = "2021-01-01 00:00:00")
    private String createTime;

    @ApiModelProperty(value = "班级结束时间",example = "2025-01-01 00:00:00")
