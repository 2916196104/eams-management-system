...
class HomeworkDTO : public oatpp::DTO
{
    ...
    DTO_FIELD(Int64, id);
    DTO_FIELD_INFO(id) {
        info->description = ZH_WORDS_GETTER("c5.home.homework.field.id");
    }

    // 2. 班级ID（bigint → Int64，NOT NULL）
    DTO_FIELD(Int64, class_id);
    DTO_FIELD_INFO(class_id) {
        info->description = ZH_WORDS_GETTER("c5.home.homework.field.class_id");
    }
