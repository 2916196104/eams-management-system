...
public:
    ENDPOINT_INFO(Register) { // 端点名称改为Register
		...
		API_DEF_ADD_QUERY_PARAMS(String, "mobile", ZH_WORDS_GETTER("register.field.telephoneNumber.info"), "", true);
		API_DEF_ADD_QUERY_PARAMS(String, "vertificationCode", ZH_WORDS_GETTER("register.field.vertificationCode.info"), "", true);
