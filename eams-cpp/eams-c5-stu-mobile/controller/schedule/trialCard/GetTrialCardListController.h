...
#include "ApiHelper.h"
#include "domain/vo/schedule/trialCard/GetTrialCardListVO.h"
...
public:
	...
	API_DEF_ENDPOINT_INFO_AUTH(
		ZH_WORDS_GETTER("schedule.trialCard.getTrialCardList.info"), getTrialCardList, GetTrialCardListPageJsonVO::Wrapper, "Schedule",
		API_DEF_ADD_QUERY_PARAMS(String, "id", ZH_WORDS_GETTER("student.id"); , "d934050a8bb373e8f8eed0bf7507ec17", true);
	);
	// 定义ID查询接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_GET, "/app/sCenter/schedule/trialCard/GetTrialCardList", 
