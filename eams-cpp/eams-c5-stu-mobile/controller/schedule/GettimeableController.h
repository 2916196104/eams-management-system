...
public://定义接口
    ENDPOINT_INFO(querytest) {
        info->summary = "get timeable";//暂时这么搞，中文词典后期要统一
        //支持授权
        API_DEF_ADD_AUTH();
        // 定义响应参数格式
        ...
        //asd之后需要加入中文词典
        API_DEF_ADD_QUERY_PARAMS(String,"teacher_name", "asd", "li", false);
        API_DEF_ADD_QUERY_PARAMS(String, "time", "asd", "Friday", false);
    }
    //接口等待后期更改
