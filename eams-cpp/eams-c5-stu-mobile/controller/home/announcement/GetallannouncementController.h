...
public://定义接口
    ENDPOINT_INFO(querytest) {
        info->summary = ZH_WORDS_GETTER("getallannouncement.summary");//暂时这么搞，中文词典后期要统一
        //支持授权
        API_DEF_ADD_AUTH();
        // 定义响应参数格式
    ...
    //接口等待后期更改
    ENDPOINT(API_M_GET, "c5/home/announcement/all/get", querytest, QUERIES(QueryParams, params), API_HANDLER_AUTH_PARAME) {
        //解析查询参数
