...
public:
    ENDPOINT_INFO(Homework) { // 端点名称改为Homework
        info->summary = ZH_WORDS_GETTER("c5.home.homework.query-all.summary"); // 国际化key适配作业业务
        ...
        // 查询参数
        API_DEF_ADD_QUERY_PARAMS(Int32, "student_id", ZH_WORDS_GETTER("c5.home.homework.field.student_id"), 1, true);
