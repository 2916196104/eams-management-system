...
public:
	...
	// 查询课程评价接口处理
	ENDPOINT(API_M_GET, "/course-evaluate", queryCourseEvaluate, QUERIES(QueryParams, queryParams), API_HANDLER_AUTH_PARAME) {
	...
	// 新增课程评价接口处理
	ENDPOINT(API_M_POST, "/course-evaluate", addCourseEvaluate, BODY_DTO(CourseEvaluateDTO::Wrapper, dto), API_HANDLER_AUTH_PARAME) {
