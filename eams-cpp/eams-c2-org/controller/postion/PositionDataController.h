...
#define API_TAG ZH_WORDS_GETTER("datapermission.tags")
...
public:
	...
	// 定义新增职位数据权限接口描述
	API_DEF_ENDPOINT_INFO_AUTH(ZH_WORDS_GETTER("datapermission.endpoint.modifyoradd"), savePositionDataPermission, Uint64JsonVO::Wrapper, API_TAG);
	...
	API_DEF_ENDPOINT_INFO_AUTH(ZH_WORDS_GETTER("datapermission.endpoint.delete"), deletePositionDataPermission, ListJsonVO<UInt64>::Wrapper, API_TAG);
