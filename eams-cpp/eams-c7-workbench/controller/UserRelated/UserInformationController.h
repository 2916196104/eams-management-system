...
*/
#ifndef _USERINFORMATIONCONTROLLER_H_
#define _USERINFORMATIONCONTROLLER_H_
...
* 获取用户信息控制器
*/
class GetUserInformationController : public oatpp::web::server::api::ApiController
{
	//定义控制器访问入口
	API_ACCESS_DECLARE(GetUserInformationController);
public:			 //定义接口
	//定义获取用户信息接口描述
