...
#include OATPP_CODEGEN_BEGIN(ApiClient)
	...
	// 通过ID查询
	API_CALL(API_M_GET, "/sample/{id}", queryById, API_HANDLER_AUTN_HEADER, PATH(String, id));
	// 多条件查询
	API_CALL(API_M_GET, "/sample", queryAll, API_HANDLER_AUTN_HEADER, API_HANDLER_PAGE_PARAME, QUERY(String, name));
