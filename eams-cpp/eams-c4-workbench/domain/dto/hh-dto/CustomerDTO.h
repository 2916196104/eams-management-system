...
class CustomerDTO : public oatpp::DTO {
	...
	// 手机号码
	API_DTO_FIELD_DEFAULT(String, phone, ZH_WORDS_GETTER("customer.field.phone"));
};
...
class CustomerDetailDTO : public oatpp::DTO {
	...
	API_DTO_FIELD_DEFAULT(String, phone, ZH_WORDS_GETTER("customer.field.phone"));
	// 性别
	API_DTO_FIELD_DEFAULT(String, sex, ZH_WORDS_GETTER("customer.field.sex"));
	// 年龄
	API_DTO_FIELD_DEFAULT(UInt16, age, ZH_WORDS_GETTER("customer.field.age"));
	// 生日
	API_DTO_FIELD_DEFAULT(String, birth, ZH_WORDS_GETTER("customer.field.birth"));
	// 类型
	API_DTO_FIELD_DEFAULT(String, customertype, ZH_WORDS_GETTER("customer.field.type"));
	// 备注
	API_DTO_FIELD_DEFAULT(String, note, ZH_WORDS_GETTER("customer.field.note"));
};
...
class CustomerLessonDTO : public oatpp::DTO {
	...
	// 剩余次数
	API_DTO_FIELD_DEFAULT(String, resttimes, ZH_WORDS_GETTER("customer.field.resttimes"));
};
