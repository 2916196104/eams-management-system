...
public:		//定义接口
	...
	// 定义保存公告接口端点
	API_HANDLER_ENDPOINT_AUTH(API_M_POST, "org/board/add-board", SaveBoard, BODY_DTO(BoardAddDTO::Wrapper, dto), executeAddBoard(dto, authObject->getPayload()));
	...
	API_HANDLER_ENDPOINT_AUTH(API_M_DEL, "org/board/remove-board", removeBoard, BODY_DTO(List<String>, ids), execRemoveBoard(ids));
