#pragma once
#ifndef _INTENDEDSTUDENT_DO_
#define _INTENDEDSTUDENT_DO_
#include "../DoInclude.h"

/**
 * 意向学员导出数据（联表查询）
 */
class IntendedExportDO : public BaseDO
{
	// 学员姓名
...
// 给IntendedExportDO智能指针设定一个别名方便使用
typedef std::shared_ptr<IntendedExportDO> PtrStudentExportDO;
