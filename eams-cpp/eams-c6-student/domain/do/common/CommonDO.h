...
class RefundDO: public BaseDO {
	...
	std::string refundAmount; //退费金额 负数
...
class PayFeesDO : public BaseDO {
	...
	std::string courseAmount; //套餐金额
	std::string discordAmount; //优惠金额
	std::string amount; //成交、合约金额
	std::string paidAmount; //实付金额
