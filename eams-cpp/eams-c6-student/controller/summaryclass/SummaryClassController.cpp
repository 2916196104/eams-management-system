...
SummaryClassPageJsonVO::Wrapper SummaryClassController::excuteSummaryClassQuery(const SummaryClassQuery::Wrapper& query)
{
    ...
    //        oss << "\xE4\xB8\x8A " << resData->getInt("up_cnt")       // "上 "
    //            << " \xE5\x81\x87 " << resData->getInt("leave_cnt")    // " 假 "
    //            << " \xE6\x97\xb7 " << resData->getInt("absent_cnt")   // " 旷 "
    //            << " \xE8\xA1\xA5 " << resData->getInt("makeup_cnt");  // " 补 "
