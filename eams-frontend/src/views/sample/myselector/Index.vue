      ...
      <div class="demo-section">
        ...
        <el-form :model="formData" label-width="100px">
          ...
          <el-form-item label="部门">
            <my-person-selector
              v-model="formData.departmentPerson"
              :data="staticData"
              placeholder="请选择部门人员"
            />
          </el-form-item>
...
function generateMockData(): PersonData[] {
  ...
  const names = [
    ...
    '姜三十五', '戚三十六', '谢三十七', '邹三十八', '喻三十九', '柏四十', '水四十一', '窦四十二',
    '章四十三', '云四十四', '苏四十五', '潘四十六', '葛四十七', '奚四十八', '范四十九', '彭五十',
    '鲁五十一', '韦五十二', '昌五十三', '马五十四', '苗五十五', '凤五十六', '花五十七', '方五十八',
    '俞五十九', '任六十', '袁六十一', '柳六十二', '酆六十三', '鲍六十四', '史六十五', '唐六十六'
  ]
