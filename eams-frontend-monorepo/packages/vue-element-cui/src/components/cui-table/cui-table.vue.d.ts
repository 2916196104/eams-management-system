...
declare const __VLS_export: <T = any>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_exposed?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
    props: import("vue").PublicProps & __VLS_PrettifyLocal<CuiTableProps<T> & {
    ...
    slots: {
        [x: string]: ((props: {
            row: any;
            column: import("./types").CuiTableColumn<T>;
            $index: any;
        }) => any) | undefined;
    };
    emit: ((evt: "sort-change", event: SortChangeEvent) => void) & ((evt: "selection-change", selection: SelectionChangeEvent<T>) => void) & ((evt: "row-click", row: T, column: any, event: Event) => void) & ((evt: "cell-click", row: T, column: any, cell: any, event: Event) => void);
}>) => import("vue").VNode & {
