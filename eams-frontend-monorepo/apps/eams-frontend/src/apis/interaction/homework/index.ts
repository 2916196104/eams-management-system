...
const mockRecordsMap: Record<number, HomeworkRecordVO[]> = {
	1: [
		{ id: 101, homeworkId: 1, studentId: 201, studentName: "赵同学", content: "已完成所有依赖注入练习", score: 95, comment: "完成得很好", commentTeacherName: "张老师", commentTime: "2026-03-16 10:00:00", addTime: "2026-03-15 20:30:00" },
		{ id: 102, homeworkId: 1, studentId: 202, studentName: "钱同学", content: "自动装配部分有些疑惑", score: 80, comment: "建议再复习一下注解", commentTeacherName: "张老师", commentTime: "2026-03-16 11:00:00", addTime: "2026-03-15 21:00:00" },
		{ id: 103, homeworkId: 1, studentId: 203, studentName: "孙同学", content: "RESTful API 已完成", score: null, comment: null, commentTeacherName: null, commentTime: null, addTime: "2026-03-16 09:00:00" },
		{ id: 104, homeworkId: 1, studentId: 204, studentName: "李同学", content: "全部完成，附带了单元测试", score: 100, comment: "非常优秀", commentTeacherName: "张老师", commentTime: "2026-03-16 14:00:00", addTime: "2026-03-15 22:00:00" },
		{ id: 105, homeworkId: 1, studentId: 205, studentName: "周同学", content: "完成了一半", score: null, comment: null, commentTeacherName: null, commentTime: null, addTime: "2026-03-16 18:00:00" },
	],
	2: [
		{ id: 201, homeworkId: 2, studentId: 201, studentName: "赵同学", content: "用户管理组件已完成", score: 90, comment: "代码结构清晰", commentTeacherName: "张老师", commentTime: "2026-03-19 10:00:00", addTime: "2026-03-18 22:00:00" },
		{ id: 202, homeworkId: 2, studentId: 202, studentName: "钱同学", content: "增删改查功能全部实现", score: 88, comment: "建议补充表单验证", commentTeacherName: "张老师", commentTime: "2026-03-19 11:00:00", addTime: "2026-03-18 23:00:00" },
	],
	3: [
		{ id: 301, homeworkId: 3, studentId: 301, studentName: "吴同学", content: "ER 图和建表 SQL 都已完成", score: 92, comment: "表结构设计合理", commentTeacherName: "李老师", commentTime: "2026-03-21 09:00:00", addTime: "2026-03-20 20:00:00" },
		{ id: 302, homeworkId: 3, studentId: 302, studentName: "郑同学", content: "设计完成，但缺少索引优化", score: 78, comment: "可以再优化索引设计", commentTeacherName: "李老师", commentTime: "2026-03-21 10:00:00", addTime: "2026-03-20 21:00:00" },
	],
};
...
function mockSaveHomework(data: HomeworkSaveDTO): JsonVO<number> {
	if (data.id) {
		...
		if (idx !== -1) {
			mockHomeworkList[idx] = { ...mockHomeworkList[idx], title: data.title, content: data.content, classId: data.classId };
			return ok(data.id);
		}
	}
