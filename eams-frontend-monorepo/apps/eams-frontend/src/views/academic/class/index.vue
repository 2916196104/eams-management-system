...
<el-card class="search-card">
  <el-form :inline="true" :model="searchForm" label-width="80px">
    ...
    <el-form-item label="教室">
      <el-select v-model="searchForm.classroomId" placeholder="请选择教室" clearable filterable style="width: 150px">
        <el-option v-for="item in classroomOptions" :key="item.id" :label="item.name" :value="item.id" />
      </el-select>
    </el-form-item>
    <el-form-item label="班主任">
      <el-select v-model="searchForm.teacherId" placeholder="请选择班主任" clearable filterable style="width: 150px">
...
import { getClassList, saveClass, deleteClass, overClass, getClassOptions, type ClassItem, type ClassListParams, type SaveClassParams } from '@/apis/academic/class';
