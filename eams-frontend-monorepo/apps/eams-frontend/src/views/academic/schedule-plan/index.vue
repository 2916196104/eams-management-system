<template>
  <div class="schedule-plan-page">
    ...
    <el-card class="action-card">
      ...
      <el-button type="warning" :disabled="selectedIds.length === 0" @click="handleBatchGenerate">批量生成课表</el-button>
    ...
    <el-card>
      ...
      <el-table :data="tableData" v-loading="loading" border stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column v-if="visibleColumns.includes('className')" prop="className" label="班级名称" min-width="150" />
        <el-table-column v-if="visibleColumns.includes('courseName')" prop="courseName" label="所属课程" min-width="150" />
        <el-table-column v-if="visibleColumns.includes('teacherNames')" prop="teacherNames" label="上课老师" min-width="120" />
        <el-table-column v-if="visibleColumns.includes('assistantNames')" prop="assistantNames" label="助教" min-width="100" />
        ...
        <el-table-column v-if="visibleColumns.includes('decLessonCount')" prop="decLessonCount" label="消课基数" width="100" />
...
import { getSchedulePlanList, saveSchedulePlan, deleteSchedulePlan, batchGenerateLesson, checkConflict, getTeacherList, type SchedulePlanItem, type SchedulePlanListParams, type SaveSchedulePlanParams } from '@/apis/academic/schedule-plan';
