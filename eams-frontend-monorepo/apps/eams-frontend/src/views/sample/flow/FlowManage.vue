<template>
  <!-- 流程元数据列表 -->
  <my-table tabtitle="流程元数据" :tabdatacolumns :tabdata :taboperbtns @taboper-click="handleOperation"
...
import { createPageDTO, type PageDTO, type MyTableColumn, type MyTableOperationsBtn, createMyTableOperationsColumn } from '@/components/mytable/type'
// 流程图编辑器相关导入
...
import type { MyFormInputNumberProps, MyFormInputProps, MyFormItemAttr, MyFormRadioBoxGroupProps, MyFormSelectProps } from '@/components/myform/type'
// 对话框相关导入
