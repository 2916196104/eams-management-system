...
<template>
  <view class="min-h-screen bg-gray-100 py-3 dark:bg-[var(--wot-dark-background)]">
    ...
    <!-- 核心团队 -->
    <title-block title="核心团队" transparent>
      <view class="grid grid-cols-2 gap-3">
        <view
          v-for="member in coreTeam" :key="member.name"
    ...
    <!-- 关于 uni-helper -->
    <title-block title="关于 uni-helper 团队" transparent>
    ...
    <!-- 更多信息 -->
    <title-block title="更多信息" transparent>
      <wd-cell-group border custom-class="rounded-2! overflow-hidden">
        <wd-cell title="关注公众号" title-width="200px" label="uni-app教程、组件库讯息一手掌握！" is-link @click="openWeChat" />
