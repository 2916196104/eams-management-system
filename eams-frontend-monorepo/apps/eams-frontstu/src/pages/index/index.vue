...
async function login() {
  Apis.login.post_login_auth_login({
...
<template>
  ...
  <!-- 操作按钮 -->
  <view class="btn-box">
    <wd-button type="primary" :round="false" size="large" block @click="login">
      登录
    </wd-button>
    <wd-button type="success" :round="false" size="large" plain block @click="navigateTo('register')">
      注册
    </wd-button>
  </view>
  <!-- 版权信息 -->
