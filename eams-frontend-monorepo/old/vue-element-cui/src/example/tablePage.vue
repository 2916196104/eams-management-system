    ...
    return {
      ...
      tableConfig: {
        ...
        fields: [
          ...
          { title: "家长姓名", name: "parentName", width: "70px", visible: ()=>{return false} },
          { title: "亲属关系", name: "familyRel", width: "70px" },
          { title: "可编辑电话", name: "mobile", width: "150px", editable: true, editFunc: this.handleEditField },
          { title: "可编辑ENUM", name: "mobile", width: "150px", editable: true, editFunc: this.handleEditField, editConf: {type: 'enum', code: 'DateRangeNameEnum'} },
          { title: "可编辑enumCheckbox", name: "mobile", width: "150px", editable: true, editFunc: this.handleEditField, editConf: {type: 'enumCheckbox', code: 'DateRangeNameEnum'} }, // , disabled: true 可以禁用编辑
          { title: "可编辑dict", name: "mobile", width: "150px", editable: true, editFunc: this.handleEditField, editConf: {type: 'dict', code: 'DateRangeNameEnum'} },
        ...
        actions: [
          ...
          },
          {
            ...
            click: async (row) => {console.log(row)},
          },
          {
            title: "操作",
            type: 'list',
