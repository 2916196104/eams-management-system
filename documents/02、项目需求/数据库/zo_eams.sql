...
CREATE TABLE `appointment`  (
  ...
  `trial_id` bigint(20) NULL DEFAULT NULL COMMENT '体验卡id 来自于体验卡的预约有',
  `trial_record_id` bigint(20) NULL DEFAULT NULL COMMENT '消费体验卡领取记录id',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `lesson_student`  (
  ...
  `consume_student_course_id` bigint(20) NULL DEFAULT NULL COMMENT '消费课程与学生关联表ID',
  `counselor` bigint(20) NULL DEFAULT NULL COMMENT '学生的顾问',
...
CREATE TABLE `student`  (
  ...
  `credit` int(20) NULL DEFAULT 0 COMMENT '学生积分',
  `org_id` bigint(20) NULL DEFAULT NULL COMMENT '创建者所属组织ID',
  `grade_id` int(11) NULL DEFAULT NULL COMMENT '年级ID',
  PRIMARY KEY (`id`) USING BTREE,
